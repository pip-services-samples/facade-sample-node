...
export class BeaconsServiceFactory extends Factory {
    public static MemoryPersistenceDescriptor = new Descriptor('pip-services-beacons', 'persistence', 'memory', '*', '1.0');
    public static FilePersistenceDescriptor = new Descriptor('pip-services-beacons', 'persistence', 'file', '*', '1.0');
    public static MongoDbPersistenceDescriptor = new Descriptor('pip-services-beacons', 'persistence', 'mongodb', '*', '1.0');
    public static ControllerDescriptor = new Descriptor('pip-services-beacons', 'controller', 'default', '*', '1.0');
    public static HttpServiceDescriptor = new Descriptor('pip-services-beacons', 'service', 'http', '*', '1.0');
